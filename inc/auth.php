...
function auth_validateToken($token) {
    ...
    $USERINFO               = $_SESSION['dol_login']; //cilos
    return true;
}
...
function auth_createToken() {
    ...
    $_SESSION[DOKU_COOKIE]['auth']['token'] = $_SESSION['token']; //NG
    session_write_close();
    return $token;
}
...
function auth_setCookie($user, $pass, $sticky) {
    ...
    $_SESSION[DOKU_COOKIE]['auth']['user'] = $_SESSION['dol_login']; //NG
    $_SESSION[DOKU_COOKIE]['auth']['pass'] = sha1($pass);
    $_SESSION[DOKU_COOKIE]['auth']['buid'] = auth_browseruid();
    //$_SESSION[DOKU_COOKIE]['auth']['info'] = $USERINFO;
    $_SESSION[DOKU_COOKIE]['auth']['info'] = $_SESSION['dol_login']; //NG

 ...
 * 	\file		core/modules/wiki.class.php
 * 	\ingroup	mymodule
 ...
 */
class modwiki extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights_class = array();
		$this->rights_class = 'wiki';
		$r=0;
		$this->rights[$r][0] = 513101;
		$this->rights[$r][1] = "Lecture wiki";
		$this->rights[$r][3] = "1";
		$this->rights[$r][4] = "wikiv"; // l'anglais est préféré
		$r++;
		
		$this->rights[$r][0] = 513102;
		$this->rights[$r][1] = "Modification wiki";
		$this->rights[$r][3] = "1";
		$this->rights[$r][4] = "wikim"; // l'anglais est préféré
		$r++;

		$this->rights[$r][0] = 513103;
		$this->rights[$r][1] = "Administration wiki";
		$this->rights[$r][3] = "1";
		$this->rights[$r][4] = "wikiad"; // l'anglais est préféré
		$r++;
		...
		$this->picto = 'wiki@wiki'; // mypicto@mymodule
		...
		$this->langfiles = array("wiki@wiki");
		// Constants
		...
		// Ajouter un onglets menu left ( oblyon ) menu haut ( autre theme )
		...
		/*$this->menu[$r]=array(	'fk_menu'=>0,			
			...
			'mainmenu'=>'monmodule',
			'leftmenu'=>'monmodule',
			'url'=>'/wiki/index.php?$query_string&start=0&ad=&sort=&s=&f=&mte_a=new&header=hide',
			'langs'=>'mylangfile',	
			'position'=>100,
			'enabled'=>'1',			
			'perms'=>'1',			
		...
		// Ajouter un onglets menu haut ( oblyon ) menu left ( autre theme )
		$this->menu[$r]=array(	
			'fk_menu'=>0,	
			'type'=>'top',
			'mainmenu' => 'wiki',		
			...
			'langs'=>'wiki@wiki',	
			'position'=>'100',
			'enabled'=>'$conf->wiki->enabled',			
			'perms'=>'$user->rights->wiki->wikiv',	
			'target'=>'',
			'user'=>2,
		);			
		$r++;
		$this->menu[]=array(	
			'fk_menu'=>'fk_mainmenu=wiki',
			'leftmenu'=>'Option',
			'type'=>'left',		
			'titre'=>'Option',
			'url'=>'/wiki/index.php',
		...
		$r++;
		$this->menu [] = array (
			'fk_menu'=>'fk_mainmenu=wiki,fk_leftmenu=Option',	
			'type' => 'left',
			'titre' => 'Modifier cette page',
			'url' => '/wiki/doku.php?id=start&do=edit',
			'langs' => 'wiki@wiki',
			'position' => '100',
			'enabled' =>'$conf->wiki->enabled',
			'perms' => '$user->rights->wiki->wikim',
			'target' => 'dokuwiki',
			'user' => 2,
		);
		$r++;
		$this->menu [] = array (
			'fk_menu'=>'fk_mainmenu=wiki,fk_leftmenu=Option',	
			'type' => 'left',
			'titre' => 'Ancienne révisions',
			'url' => '/wiki/doku.php?id=start&do=revisions',
			'langs' => 'wiki@wiki',
			'position' => '101',
			'enabled' =>'$conf->wiki->enabled',
			'perms' => '$user->rights->wiki->wikim',
		...
		$this->menu [] = array (
			'fk_menu'=>'fk_mainmenu=wiki,fk_leftmenu=Option',	
			'type' => 'left',
			'titre' => 'Liens de retour',
			'url' => '/wiki/doku.php?id=start&do=backlink',
			'langs' => 'wiki@wiki',
			'position' => '102',
			'enabled' =>'$conf->wiki->enabled',
			'perms' => '$user->rights->wiki->wikim',
		...
		$this->menu [] = array (
			'fk_menu'=>'fk_mainmenu=wiki,fk_leftmenu=Option',	
			'type' => 'left',
			'titre' => 'Dernier changement',
			'url' => '/wiki/doku.php?id=start&do=recent',
			'langs' => 'wiki@wiki',
			'position' => '103',
			'enabled' =>'$conf->wiki->enabled',
			'perms' => '$user->rights->wiki->wikim',
		...
		$this->menu [] = array (
			'fk_menu'=>'fk_mainmenu=wiki,fk_leftmenu=Option',	
			'type' => 'left',
			'titre' => 'Gestionnaire multimédia',
			'url' => '/wiki/doku.php?id=start&do=media&ns=',
			'langs' => 'wiki@wiki',
			'position' => '104',
			'enabled' =>'$conf->wiki->enabled',
			'perms' => '$user->rights->wiki->wikiad',
			'target' => 'dokuwiki',
			'user' => 2,
		);
		$r++;
		$this->menu [] = array (
			...
			'type' => 'left',
			'titre' => 'Administrer',
			'url' => '/wiki/doku.php?id=start&do=admin',
			'langs' => 'wiki@wiki',
			'position' => '104',
			'enabled' =>'$conf->wiki->enabled',
			'perms' => '$user->rights->wiki->wikiad',
	...
	{
		return $this->_load_tables('/vemps/sql/');
	}*/
}
